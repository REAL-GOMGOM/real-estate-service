...
export const APT_ALIASES: Record<string, string[]> = {
  ...
  // 서초구/강남구
  '래미안퍼스티지': ['반포래미안퍼스티지'],
  // '아크로리버파크': 사이클 H — '반포현대' 매핑 검증 안 됨, Phase 2 DB 데이터로 대체
  '래미안원베일리': ['래미안원베일리'],
  '디에이치아너힐즈': ['개포주공8단지'],

  // 송파구
  '헬리오시티': ['송파헬리오시티', '가락시영'],
  // '잠실엘스'/'잠실리센츠'/'잠실래미안아이파크': 사이클 H — '잠실주공5단지' 잘못된 매핑 제거
  // (실제 잠실엘스는 잠실주공1단지 재건축, 리센츠는 2단지, 트리지움은 3단지)
  '올림픽파크포레온': ['둔촌주공'],
  '파크리오': ['잠실파크리오'],
  ...
  // 마포구
  // '래미안마포리버웰': 사이클 H — '마포래미안푸르지오' 매핑 검증 안 됨, 별개 단지로 추정
  '마포프레스티지자이': ['마포프레스티지자이'],
