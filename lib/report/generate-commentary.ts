...
- topYearHighs는 정상 범위(상승률 30% 미만) 신고가만 포함합니다. 이 데이터로 분석하세요.
- 상승률 30% 이상의 극단적 거래는 별도 섹션('눈여겨볼 거래')에서 다루므로, 본문에서 인용하지 마세요. 재건축, 리모델링, 또는 특수 사례일 가능성이 있습니다.
- 정상 신고가의 일반적 패턴, 시도별 흐름, 가격대 분포에 집중하세요.`;
