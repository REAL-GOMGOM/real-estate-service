      ...
      >
        ...
        >
          ...
          <section id="field-reports" className="scroll-mt-24">
            <h2 className="mb-3 text-xl font-semibold" style={{ color: 'var(--text-strong)' }}>현장 제보가격 이용 기준</h2>
            <p>현장 제보가격은 이용자가 전하는 계약 소식으로 공식 실거래 자료가 아닙니다. 제보자는 호가·매물 광고가 아닌 최근 90일 이내 실제 체결된 계약에 관한 내용만 제출해야 하며 타인의 개인정보를 입력해서는 안 됩니다. 소식 출처는 제보자가 직접 선택한 것으로 자격 인증이나 사실 확인을 의미하지 않습니다.</p>
            <p className="mt-3">접수된 내용은 관리자 검수 후 게시될 수 있습니다. 검수는 내용의 적합성을 살피는 절차이며 거래 사실이나 가격의 진위를 보증하지 않습니다. 제보는 공식 거래량·평균가격·신고가 등 통계에 합산하지 않으며 자동으로 공식 확인 상태로 전환하지 않습니다.</p>
            <p className="mt-3">허위·중복·개인정보 포함 제보는 신고할 수 있으며 운영자는 검토 후 반려하거나 숨길 수 있습니다. 접수 후 30일이 지난 제보는 공개 목록에서 제외합니다. 신고가 접수되었다는 이유만으로 허위 정보라고 단정하지 않습니다. 정정·삭제 요청은 접수번호와 함께 문의 이메일로 보내주세요.</p>
            <p className="mt-3 text-sm">제보 기능 도입 안내: 2026년 8월 31일 · 제보 시 별도로 확인·동의한 이용자에게 적용됩니다.</p>
          </section>
