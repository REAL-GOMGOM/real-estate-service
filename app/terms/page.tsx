      ...
      >
        ...
        >
          ...
          <section id="field-reports" className="scroll-mt-24">
            ...
            <p>현장 제보가격은 이용자가 전하는 계약 소식으로 공식 실거래 자료가 아닙니다. 제보자는 호가·매물 광고가 아닌 최근 90일 이내 실제 체결된 계약에 관한 내용만 제출해야 하며 타인의 개인정보를 입력해서는 안 됩니다. 제보자 구분은 본인이 선택한 것으로 자격 인증을 의미하지 않습니다.</p>
